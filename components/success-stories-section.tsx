...
const caseStudies = [
  ...
  },
  {
    ...
    logo: "/elite-baseball-training-logo.png",
          ...
          <div className="flex items-start justify-between gap-8">
            <div>
              <h2 className="text-5xl md:text-6xl lg:text-7xl font-serif text-gray-900 leading-tight max-w-4xl mb-6">
                Real revenue from{" "}
                <span className="text-gray-400 italic">real families.</span>
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl">
                From basketball clinics to swim trials, Movo turns everyday
                parent conversations into booked programs and recurring revenue.
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[0, 1].map((offset) => {
            ...
            return (
              ...
              >
                <div className="absolute top-6 right-6 text-xs text-gray-400 italic">
                  {caseStudy.timestamp}
                </div>
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 self-center">
                    {caseStudy.company}
                  </h3>
                </div>
                ...
                <div className="flex flex-col gap-6 sm:grid sm:grid-cols-3 sm:gap-4 pt-6 border-t border-gray-300">
                  {caseStudy.stats.map((stat, idx) => (
                    <div key={idx} className="text-center py-2 sm:py-0">
                      <div className="text-3xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-2">
                        {stat.value}
                      </div>
                      <div className="text-sm sm:text-xs text-gray-600 leading-tight px-2">
                        {stat.label}
                      </div>
                    </div>
                  ))}
